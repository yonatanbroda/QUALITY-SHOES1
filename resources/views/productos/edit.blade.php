...
@section('content')
    ...
    <form method="post" action="{{ route('productos.update', $producto) }}">
        ...
        <div class="form-group col-md-3">
            <h5>Color:</h5>
            <input type="text" name="color" value="{{ $producto->color }}" class="focus border-dark  form-control"
                min="3" max="10" maxlength="10" size="0" pattern="[a-zA-Z]{3,10}" placeholder="Color"
                required>
            @error('color')
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" name="precio" value="{{ $producto->precio }}" class="focus border-dark  form-control"
                min="1" max="5" maxlength="4" size="0" pattern="[0-9]{1,4}" placeholder="Precio"
                required>
            @error('precio')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" name="descripcion" value="{{ $producto->descripcion }}"
                class="focus border-dark  form-control" min="5" max="20" maxlength="20" size="0"
                pattern="{5,20}" placeholder="Descripcion" required>
            @error('descripcion')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
