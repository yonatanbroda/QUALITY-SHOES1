...
Route::get('/', function () {
    $deseo = Deseo::all();
    return view('auth.login'); //RETORNA LA VISTA WELCOME
});
...
/////////////////////////////////////////////////////
/////////////////////////////////////////////////////
Route::resource('notaingresos', NotaingresoController::class)->names('notaingreso');
Route::resource('detallenotaingreso', DetalleNotaIngresoConroller::class)->names('detallenotaingreso');
